        ...
        <div className="min-h-screen flex flex-col items-center p-6 bg-[#121212] text-gray-300">
            <div className="w-full max-w-5xl bg-[#1E1E1E] shadow-md rounded-md p-8">
                ...
                <h1 className="text-3xl font-bold mb-6">
                    Welcome to Nitrutsav 2025!
                </h1>

                <p className="mb-6">
                    The website linked gives you the outline of our protocols.
                    If you agree to the set of terms and conditions, you are
                    welcomed as an entrant and will be redirected to proceed
                    further.
                </p>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <p>
                            Unless otherwise stated, Nitrutsav and/or its
                            licensors own the intellectual property rights for
                            all material on Nitrutsav 2025. All intellectual
                            property rights are reserved. You may access this
                            from Nitrutsav 2025 for your personal use subject to
                            restrictions set in these terms and conditions.
                        </p>
                        <ul className="list-disc pl-6 mt-4 space-y-2">
                            <li>
                                Copy or republish material from Nitrutsav 2025
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <p>
                            Students from recognized educational institutions
                            across India are eligible to participate in
                            Nitrutsav 2025. However, students from blacklisted
                            institutions (e.g., Siksha O Anusandhan (SOA)
                            University, including all its affiliated colleges,
                            and Institute of Technical Education and Research
                            (ITER)) are strictly prohibited from registering or
                            participating in the fest.
                        </p>
                        <p className="mt-4 font-semibold">Note:</p>
                        <p>
                            If a student from a banned institution registers,
                            their registration will be canceled, and no refund
                            will be provided.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            To the maximum permitted visitors conduct, nothing
                        ...
                        <p className="mt-4">
                            As the website can be accessed by all verified
                            visitors, we shall not uphold any liability for any
                            damage.
                        </p>
                    </div>
                </div>
