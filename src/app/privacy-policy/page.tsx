        ...
        <div className="min-h-screen flex flex-col items-center p-6 bg-[#121212] text-gray-300">
            <div className="w-full max-w-5xl bg-[#1E1E1E] shadow-md rounded-md p-8">
                ...
                <p className="mb-6">
                    ...
                    with this Privacy Policy. This Privacy Policy has been
                ...
                <ul className="list-disc pl-6 mb-6 space-y-2">
                    ...
                    <li>
                        ...
                        the Service such as a computer, a cell phone or a
                        digital tablet.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Website</strong> refers to the official website
                        of Nitrutsav.
                    </li>
                    <li>
                ...
                <p className="mb-6">
                    ...
                    diagnostic data. When You access the Service by or through a
                    ...
                    Service or when You access the Service by or through a
                    mobile device.
                </p>
                ...
                <ul className="list-disc pl-6 mb-6 space-y-2">
                    ...
                    <li>
                        ...
                        restructuring, reorganisation, dissolution, or other
                ...
                <ul className="list-disc pl-6 mb-6 space-y-2">
                    <li>
                        With Service Providers to monitor and analyse the use of
                        our Service.
                    </li>
                    <li>
                        For business transfers during mergers, sales, or
                        acquisitions.
                    </li>
                    <li>
                        With Affiliates, requiring them to honour this Privacy
                        Policy.
                    </li>
                    <li>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            and in any other places where the parties involved
                            in the processing are located. This information may
                            be transferred to — and maintained on — computers
                            located outside of Your state, province, country, or
                            other governmental jurisdiction where data
                            ...
                            accordance with this Privacy Policy. No transfer of
                            Your Personal Data will take place to an
                            organisation or country unless there are adequate
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            in deleting the Personal Data we have collected
                            about you. Our Service may allow you to delete
                            certain information from within the Service. You may
                            update, amend, or delete your information at any
                            time by signing in to your Account and accessing the
                            settings. You may also contact us to request access
                            to, correct, or delete any personal information
                            provided. However, we may retain certain information
                            when we have a legal obligation or lawful basis to
                            do so.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            In cases of business transactions, such as mergers,
                            acquisitions, or asset sales, your Personal Data may
                            be transferred with notice. Under specific
                            conditions, such as legal requests from public
                            authorities or to protect company rights, prevent
                            wrongdoing, or ensure public safety, we may disclose
                            your data in good faith. Such actions may be
                            required to comply with legal obligations, defend
                            company rights, or protect user safety and
                            liability.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            We prioritize the security of your data, employing
                            commercially acceptable methods for protection.
                            However, please note that no method of internet
                            transmission or electronic storage can guarantee
                            absolute security. While we take steps to protect
                            your information, we cannot ensure it will be fully
                            secure.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            identifiable information from anyone under this age.
                            If you are a parent or guardian and discover that
                            your child has provided us with Personal Data,
                            please contact us. We will take steps to remove that
                            data from our servers. If parental consent is
                            legally required in your country, we may require
                            this consent before collecting and using such
                            information.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            not operated by us. If you click on a third-party
                            link, you will be directed to that third-party’s
                            site. We strongly advise you to review the Privacy
                            Policy of every site you visit, as we have no
                            control over, and are not responsible for, the
                    ...
                    <div>
                        ...
                        <p>
                            We may periodically update our Privacy Policy. We
                            will notify you of changes by posting the new
                            Privacy Policy on this page and sending you an email
                            and/or a prominent notice on our Service before the
                            change becomes effective. The “Last updated” date at
                            the top of this Privacy Policy will also be revised.
                            Changes to this Privacy Policy are effective when
                            posted. Please review this Privacy Policy regularly
                            for any updates.
                        </p>
                    </div>
